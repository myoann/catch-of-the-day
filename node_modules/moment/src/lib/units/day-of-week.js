...
export var defaultLocaleWeekdays = 'dimanche_lundi_mardi_mercredi_jeudi_vendredi_samedi'.split('_');
...
export var defaultLocaleWeekdaysShort = 'dim._lun._mar._mer._jeu._ven._sam.'.split('_');
export function localeWeekdaysShort (m) {
    return (m) ? this._weekdaysShort[m.day()] : this._weekdaysShort;
}

export var defaultLocaleWeekdaysMin = 'Di_Lu_Ma_Me_Je_Ve_Sa'.split('_');
